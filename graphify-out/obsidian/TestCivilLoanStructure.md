...
# TestCivilLoanStructure

## Connections
- [[.test_report_json_roundtrip()]] - `method` [EXTRACTED]
...
- [[Structural integrity checks specific to civil_loan case type.]] - `rationale_for` [EXTRACTED]
- [[TimelineEvent_1]] - `uses` [INFERRED]
- [[test_civil_loan_acceptance.py]] - `contains` [EXTRACTED]
