...
# FactProposition.linked_evidence_ids 中未知 evidence_id 应被过滤。 Unknown evidence_

## Connections
- [[IssueExtractor]] - `uses` [INFERRED]
- [[ValidationReport]] - `uses` [INFERRED]
- [[test_unknown_evidence_ids_filtered_from_fact_propositions()]] - `rationale_for` [EXTRACTED]
