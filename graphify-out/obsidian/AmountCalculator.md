...
- [[._build_claim_calculation_table()]] - `method` [EXTRACTED]
- [[._check_all_repayments_attributed()]] - `method` [EXTRACTED]
- [[._check_claim_delivery_ratio()]] - `method` [EXTRACTED]
- [[._check_duplicate_interest_penalty()]] - `method` [EXTRACTED]
- [[._check_principal_base_unique()]] - `method` [EXTRACTED]
- [[._check_text_table_consistent()]] - `method` [EXTRACTED]
- [[._check_total_reconstructable()]] - `method` [EXTRACTED]
- [[._compute_principal_amount()]] - `method` [EXTRACTED]
- [[._generate_conflicts()]] - `method` [EXTRACTED]
- [[._recalculate_interest()]] - `method` [EXTRACTED]
- [[._sum_principal_loans()]] - `method` [EXTRACTED]
- [[._sum_principal_repayments()]] - `method` [EXTRACTED]
...
- [[calculator.py]] - `contains` [EXTRACTED]
...
- [[金额 诉请一致性确定性计算器。 所有方法均为同步纯函数，不持有外部状态，可安全复用同一实例。 使用方式 Usage]] - `rationale_for` [EXTRACTED]
