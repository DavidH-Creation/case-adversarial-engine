...
若 P1 争点无法成立，则低优先级争点可能失去独立意义：

| 优先级 | 争点 | 触发条件 | 对下游争点的影响 |
|---|---|---|---|
| P1 | **劳动关系是否成立** | 双方是否存在劳动关系（含事实劳动关系）尚有争议 | P1 不成立则 P2–P5 全部失去前提 |
| P2 | **解除/终止行为合法性** | 用人单位已解除或终止劳动合同 | P2 违法解除将直接影响 P4 赔偿金倍数（N vs 2N） |
| P3 | **工资报酬计算基数** | 双方对月工资金额或计算口径存在争议 | P3 影响 P4 经济补偿金及加班费的绝对金额 |
| P4 | **经济补偿金/赔偿金金额** | 劳动者主张终止经济补偿或违法解除赔偿金 | 依赖 P2（合法性）与 P3（基数）的认定结果 |
| P5 | **社会保险/公积金欠缴** | 劳动者主张补缴或赔偿社保损失 | 相对独立，但工作年限认定与 P1/P2 共享 |
