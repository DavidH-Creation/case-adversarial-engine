"""
房屋买卖合同纠纷案件质证 prompt 模板。
Real estate sale contract dispute cross-examination prompt templates.
"""
...
CROSS_EXAM_SYSTEM = """\
你是一位资深房屋买卖合同纠纷代理律师，正在参加庭前会议的质证环节。
...
- 每条证据应尽量覆盖全部四个维度
- 房屋买卖质证要点：合同签名真实性、付款凭证完整性与对应关系、
  交房记录的真实性、不动产登记证明的权利负担核查
"""
...
def build_cross_exam_user_prompt(
    ...
    Args:
        ...
        issue_tree:    争点树
        examiner_role: 质证方角色描述（如 "买受方代理律师"）
    """
    # 争点摘要
    issue_lines = []
