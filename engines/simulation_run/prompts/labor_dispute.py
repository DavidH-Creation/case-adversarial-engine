...
def build_user_prompt(
    *,
    ...
    local import. The helpers shape dict structures (issue tree / evidence
    list / change set), not case-specific text, so reuse is safe. A future
    cleanup may extract them to a shared module.
    """
